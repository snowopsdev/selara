...
function renderGeneral() {
  ...
  s.innerHTML = `
    ...
    <div class="card">
      ...
      <p class="hint">Examples: ctrl+shift+space, option+space, cmd+shift+w. With `selara serve` running, changes apply within about a second.</p>
      <div class="actions">
...
function renderModels() {
  ...
  s.innerHTML = `
    ...
    <div class="card">
      ...
      <input id="api_key" type="password" value="${escapeAttr(p.api_key || "")}" placeholder="sk-… or leave empty to use SELARA_API_KEY" />
      <p class="hint">Stored in ~/.config/selara/config.toml. Prefer env SELARA_API_KEY when possible.</p>
      <div class="actions">

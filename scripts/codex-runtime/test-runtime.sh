...
cargo build --manifest-path "$source_dir/Cargo.toml" --locked -p selara-codex --features selara-test-support
exec python3 "$repo_dir/scripts/codex-runtime/test-runtime.py" --binary "$CARGO_TARGET_DIR/debug/selara-codex" -v
